...
public class Employee implements Serializable {
    ...
    private final ArrayList<CorrectionRequest> corrections;


    public Employee(int employee_id, String name, ArrayList<PayPeriod> payperiods, Tracker tracker, ArrayList<CorrectionRequest> corrections)
    {
    ...
    /**
     * Add new pay periods to the employee's pay period list.
     * This is necessary when the organization's pay period list is updated, and employee's need to be updated as well to match.
     * @param newPayPeriods array of new pay periods to add
     */
    public void addNewPayPeriods(ArrayList<PayPeriod> newPayPeriods) {
        payperiods.addAll(newPayPeriods);
    }


    /** @return The employee's history of correction requests */
    public ArrayList<CorrectionRequest> getCorrections() {
        return corrections;
    }
     ...
     */
    public double setClockedIn(boolean clocked_in) throws PayPeriodOutOfBoundsException
    {
        // Set employee status
     ...
     */
    public boolean addToCurrentPayPeriod(Calendar date, double hours) throws PayPeriodOutOfBoundsException
    {
     ...
     */
    public PayPeriod getPayPeriod(Calendar date) throws PayPeriodOutOfBoundsException
    {
        ...
        // The algorithm failed to match a pay period, throw PayPeriodOutOfBoundsException
        throw new PayPeriodOutOfBoundsException("Failed to locate a matching pay period.");
    }
